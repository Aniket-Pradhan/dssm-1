...
class Model:
    ...
    def train(self,training_set,test_set):
        ...
        with tf.Session(graph=self.graph) as sess:
            ...
            train_writer = tf.summary.FileWriter(self.paras['logdir'] + '/train', sess.graph)
            test_writer = tf.summary.FileWriter(self.paras['logdir'] + '/test', sess.graph)
            ...
            for step in range(self.paras['num_steps']):
                ...
                saver.save(sess,self.paras['model_dir'],global_step=step)
